...
import Wachturm from './buildings/Wachturm';
import Mauer from './buildings/Mauer';
...
export function BuildingRenderer({ type, level = 1, size = 120 }: Props): React.ReactElement | null {
  ...
  switch (type) {
    ...
    case 'wachturm':  return <Wachturm level={lvl} size={size} />;
    case 'mauer':     return <Mauer level={lvl} size={size} />;
    default:          return null;
  }
}
