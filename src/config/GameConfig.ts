...
export const STREAK_CONFIG = {
  ...
  milestones: [
    ...
    { days: 7,   emoji: '🔥', nameKey: 'streak.milestones.7.name',   rewardDescKey: 'streak.milestones.7.reward',   reward: { protein: 3, streakShield: true, shields: 1 } },
    ...
    { days: 21,  emoji: '⚡', nameKey: 'streak.milestones.21.name',  rewardDescKey: 'streak.milestones.21.reward',  reward: { protein: 5, holz: 300, profileFrame: 'Eisenkrieger', shields: 1 } },
    ...
    { days: 50,  emoji: '💎', nameKey: 'streak.milestones.50.name',  rewardDescKey: 'streak.milestones.50.reward',  reward: { protein: 10, holz: 1000, permanentKalorienBonus: true, shields: 2 } },
