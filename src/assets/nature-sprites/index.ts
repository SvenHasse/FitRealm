// Nature sprite index — pre-rendered 3D Low Poly isometric PNGs
...
export const TREE_SPRITES: NatureSpriteKey[] = [
  ...
  'Willow_1', 'Willow_2', 'Willow_3',
];

export const SMALL_PROP_SPRITES: NatureSpriteKey[] = [
  'Bush_1', 'Bush_2', 'BushBerries_1', 'BushBerries_2',
  'Rock_1', 'Rock_2', 'Rock_3', 'Rock_Moss_1', 'Rock_Moss_2',
  'TreeStump', 'TreeStump_Moss', 'WoodLog',
];

export const GROUND_DETAIL_SPRITES: NatureSpriteKey[] = [
  'Grass', 'Grass_Short', 'Plant_1', 'Plant_3', 'Flowers',
];
